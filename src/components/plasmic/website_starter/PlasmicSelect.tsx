...
import MenuPopover from "../../MenuPopover"; // plasmic-import: 4cOU2lviDdKe/component
import MenuItem from "../../MenuItem"; // plasmic-import: F-akhht0x6mU/component
import MenuSection from "../../MenuSection"; // plasmic-import: Oq4zydm15egG/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: HhjbKLn-Q9iQ/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__u2Mbq)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
