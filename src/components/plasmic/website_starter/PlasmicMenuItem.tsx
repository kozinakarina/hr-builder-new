...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: F-akhht0x6mU/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__twdtf)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__xeTfs)}>
            <div
              className={classNames(
                projectcss.all,
