...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 9zXv9_EQiDeP/css
...
export type PlasmicButton__VariantsArgs = {
  color?: SingleChoiceArg<
    "neutral" | "muted" | "success" | "warning" | "errorDestructive" | "v2"
  >;
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    <BaseButton
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_v2]: hasVariant($state, "color", "v2"),
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___1Pgat, {
          [sty.freeBoxcolor_neutral___1PgatHqypC]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_v2___1PgatN1HQh]: hasVariant($state, "color", "v2"),
          [sty.freeBoxroundedFull___1PgatG9AYh]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge___1PgatCvOqa]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall___1PgatlVg]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large___1PgatJk3Oa]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small___1Pgathlc2Z]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered___1PgatOziCf]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success___1PgatOziCfL7KoO]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__t8Vg6, {
            [sty.freeBoxcolor_neutral__t8Vg6HqypC]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__t8Vg6FUBtY]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__t8Vg6CvOqa]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__t8Vg6Jk3Oa]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__t8Vg6Hlc2Z]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__t8Vg6OziCf]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__t8Vg6CknMuHqypC]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__h8SfS)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__elgq6, {
            [sty.freeBoxiconEnd__elgq6GIvR]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__elgq6CvOqa]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__elgq6Jk3Oa]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__elgq6Hlc2Z]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__vmCcA)}
                role={"img"}
              />
            ),
