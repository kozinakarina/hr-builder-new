...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: 5-d3Muddk6Z1/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: xnfnz78MKU_8/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: NuH5YO95u7wr/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__gpUtv)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__kKzuF)}
            role={"img"}
          />
        ) : null}
      </div>
