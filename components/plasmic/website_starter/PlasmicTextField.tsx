...
import Label from "../../Label"; // plasmic-import: mFBj0JYN8Vgq/component
import TextInput from "../../TextInput"; // plasmic-import: _HcmTTxAcSNo/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: otlahZTjtSIv/component
import Description from "../../Description"; // plasmic-import: PtGI69GL9gZb/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: N-XREVNSHa2i/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__dhyFw, {
          [sty.freeBoxiconEnd__dhyFwQzx9R]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__dhyFwSaHm2]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__dhyFwxLnxR]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__hvCxu, {
            [sty.freeBoxiconStart__hvCxuSaHm2]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__hvCxuxLnxR]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__f21K5)}
                role={"img"}
              />
            ),
        ...
        {(hasVariant($state, "multiLine", "multiLine") ? false : true) ? (
          <TextInput
            ...
            className={classNames("__wab_instance", sty.год, {
              [sty.годiconEnd]: hasVariant($state, "iconEnd", "iconEnd"),
              [sty.годiconEnd_iconStart]:
                hasVariant($state, "iconStart", "iconStart") &&
                hasVariant($state, "iconEnd", "iconEnd"),
              [sty.годiconStart]: hasVariant($state, "iconStart", "iconStart"),
              [sty.годmultiLine]: hasVariant($state, "multiLine", "multiLine")
            })}
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___76Wi2, {
            [sty.freeBoxiconEnd___76Wi2Qzx9R]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___76Wi2SaHm2]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__ukaxa)}
                role={"img"}
              />
            ),
